...
Проблема N+1 - это, когда для каждой записи основной таблицы запроса выполняются дополнит. запросы к связанной талицы. Вместо этого нужен один запрос к связанной таблице.
